...
insert  into `feedback`(`feedid`,`name`,`subject`,`msg`,`email`,`ip`) values (12,'ZhangDongNan','java核心编程','123','email','0:0:0:0:0:0:0:1'),(13,'ZhangDongNan2','Struts2','这本书还可以','eamil','0:0:0:0:0:0:0:1');
...
(2,'Struts2权威指南','《Struts2权威指南:基于WebWork核心的MVC开发》介绍的Struts 2已经完全超出了Struts 1框架原有的高度，Struts 2建立在Struts 1和WebWork两个框架整合的基础之上，因此提供了更多优秀的机制。','虽然Struts 1目前还未被完全淘汰，但Struts 1所表现出来的缺陷已经处处制约着开发者的手脚。在2007年上半年，Struts 2终于在众多开发者期盼中，发布了第一个稳定版本：2.0.6。为了让众多Struts学习、工作者快速掌握Struts 2的开发，笔者精心编著了本书。本书按Struts 2的架构体系，细致地介绍了Struts 2各个知识点。在介绍过程中，笔者依照读者的学习规律，首先介绍基本概念和基本操作，然后对内容进行深入讲解。笔者在介绍Struts 2框架时，既照顾到Struts 2初学者的能力，对每个知识点都给出简单的快速上手的示例；同时也考虑到开发者在日后开发中可能遇到的问题，详细讲解了每个知识点的各种用法，本书覆盖到Struts 2近80%的API。因此，本书完全可以作为Struts 2框架的权威手册，以供开发者在实际开发过程中参考。\n本书最后配备了几个常用场景的实例，通过实例演示了Struts 2框架的用法，希望读者可以通过这几个实例，触类旁通，解决日常开发中的问题。',40,'08.jpg','程序框架'),
(3,'Python核心编程','Python是一种功能十分强大的面向对象编程语言，可以用于编写独立程序、快速脚本和复杂应用的原型。作为一种开源软件，Python可以自由获取，而且非常易学易用。本书是Python语言的经典入门读本，由两名顶尖的Python技术专家兼培训专家联手撰写，涵盖了该语言的所有核心内容。所有练习的解答都可在书后找到。 本书描述了Python程序的基本构件：类型、操作符、语句、函数、模块、类以及异常和介绍了更','本书是经典的Python[1]  指导书，在第一版的基础上进行了全面升级。全书分为两个部分：第1部分占据了大约三分之二的篇幅，阐释这门语言的“核心”内容，包括基本的概念和语句、语法和风格、Python对象、数字类型、序列类型、映射和集合类型、条件和循环、文件和输入/输出、错误和异常、函数和函数式编程、模块、面向对象编程、执行环境等内容：第2部分则提供了各种高级主题来展示可以使用Python做些什么，包括正则表达式、网络编程、网络客户端编程、多线程编程、图形用户界面编程、Web编程、数据库编程、扩展Python 和一些其他材料。',58,'11.jpg','编程语言'),
(4,'计算机网络','《计算机网络：自顶向下方法(原书第6版)》第6版继续保持了以前版本的特色，为计算机网络教学提供了一种新颖和与时俱进的方法，同时也进行了相当多的修订和更新：第1章更多地关注时下，更新了接入网的论述；第2章用python替代了java来介绍套接字编程；第3章补充了用于优化云服务性能的tcp分岔知识；第4章有关路由器体系结构的内容做了大量更新；第5章重新组织并新增了数据中心网络的内容；第6章更新了无线网','《计算机网络：自顶向下方法(原书第6版)》第1版于12年前出版，首创采用自顶向下的方法讲解计算机网络的原理和协议，出版以来已被几百所大学和学院选用，是业界最经典的计算机网络教材之一。',35,'12.jpg','专业基础'),
(5,'C++程序设计','《C++程序设计》是依据ANSI C++标准进行介绍的，引导读者从一开始就按标准C++的规定编程。本书配有两本辅导教材，即《C++程序设计题解与上机指导》和《C++编程实践指导》，全书分为4篇：基本知识；基于过程的程序设计；基于对象的程序设计；面向对象的程序设计。 本书内容全面，例题丰富，概念清晰，循序渐进，易于学习，即使没有教师讲授，读者也能看懂本书的大部分内容。本书是学习C++的入门教材，可供','本书是为已学过C语言程序设计、具有程序设计初步知识的读者编写的，是与作者编著的《C++面向对象程序设计》（清华大学出版社出版）一书配套的辅助教材。本书包括3个部分: 《C++面向对象程序设计》一书各章中的全部习题的参考解答；C++的上机操作,这部分介绍了在两种典型的环境下运行C++程序的方法，即Visual C++6.0和GCC在DOS/Windows平台上的版本DJGPP（以及与之配合使用的集成软件开发环境RHIDE）；上机实验内容与安排，这部分提出了上机实验的指导思想和上机实验的内容与安排，供教学参考。',24,'13.jpg','编程语言');
...
insert  into `users`(`userid`,`username`,`password_`,`grade`,`truename`,`email`,`phone`,`address_`) values
(4,'admin','admin','管理员','张东南','364800693@qq.com','13900000000','北京市朝阳区'),
(5,'test1','1234','用户','dongnan','364800693@qq.com','13900000000','福州市'),
(6,'test2','1234',NULL,NULL,NULL,NULL,NULL),(7,'test3','1234',NULL,NULL,NULL,NULL,NULL);
